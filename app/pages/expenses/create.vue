<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <!-- Success Modal -->
    <div v-if="showSuccessModal" class="fixed inset-0 z-[9999] flex items-center justify-center p-4" style="position: fixed; top: 0; left: 0; right: 0; bottom: 0;">
      <!-- Overlay -->
      <div class="absolute inset-0 bg-black bg-opacity-50" @click="showSuccessModal = false" />
      ...
      <div class="relative bg-white rounded-lg shadow-xl max-w-md w-full mx-auto" style="z-index: 10000;">
        <div class="p-6 text-center">
          ...
          <div v-if="createdExpense" class="text-sm text-gray-600 mb-6">
            <p class="mb-2">
              <strong>{{ createdExpense.description }}</strong> has been submitted.
            </p>
